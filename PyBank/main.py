...
#set path for file 
csvpath = os.path.join('/Users/patricbeaven/Desktop/Bootcamp/03-Python/Starter_Code/PyBank/Resources/budget_data.csv')
...
file = os.path.join("/Users/patricbeaven/Desktop/Bootcamp/03-Python/Starter_Code/PyBank/Resources/Output.txt")
